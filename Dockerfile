...
COPY --chmod=o+wrX . /workspaces/hdf5-reader-service
WORKDIR /workspaces/hdf5-reader-service
...
RUN git remote set-url origin git@github.com:DiamondLightSource/hdf5-reader-service.git
